...
/**
 * @brief lê um arquivo de indice e cria um vetor de índices
 * 
 * @param index_filename nome do arquivo de índice a ser lido
 * @param parameter diferencia int de string
 * @return o vetor de indices, que trata colisões empilhando-as em listas ligadas 
 */
